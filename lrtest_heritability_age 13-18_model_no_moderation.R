#Supplementary Table 3: model fitting for likelihood ratio tests: T1D heritability at age 13-18_model 4 (without ba or parameter) based on all sibling pairs
#Figure 2(A), Figure 2(B): obtain point estimates for heritability and environmental contribution at age 13-18 based on model 4
...
AE_t1d1318_any_nomod <- mxRun( AEmod , intervals=TRUE ) #0.58[95% CI: 0.51, 0.66]; e2: 0.42(95% CI: 0.34, 0.49)

#All fit attempts resulted in errors - check starting values or model specification
summary(AE_t1d1318_any_nomod)
save(AE_t1d1318_any_nomod, file="AE_t1d1318_any_nomod.RData") #names to be changed

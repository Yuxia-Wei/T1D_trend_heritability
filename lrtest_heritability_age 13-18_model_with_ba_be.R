#Supplementary Table 3: model fitting for likelihood ratio tests: T1D heritability at age 13-18_model 1(with ba and be parameters) based on all sibling pairs
#OpenMx
...
datWide$by_1=(datWide$birth_year_index-1994)/25
datWide$by_2=(datWide$birth_year-1994)/25
...
# Fit the model
AE_t1d1318_any <- mxRun( AEmod , intervals=TRUE )

summary(AE_t1d1318_any)
save(AE_t1d1318_any, file="AE_t1d1318_any.RData") #names to be changed

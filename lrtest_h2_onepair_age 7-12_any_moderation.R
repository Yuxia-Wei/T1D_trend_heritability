#Supplementary Table 4: model fitting for likelihood ratio tests: T1D heritability at age 7-12_model 1(with ba and be parameters) based on one sibling pair from each family
#OpenMx
...
# Fit the model
AE_t1d712_any_onepair <- mxRun( AEmod , intervals=TRUE )

summary(AE_t1d712_any_onepair)
save(AE_t1d712_any_onepair, file="AE_t1d712_any_onepair.RData") 

#Supplementary Table 3: model fitting for likelihood ratio tests: T1D heritability at age 7-12_model 3 (with be parameter) based on all sibling pairs
#OpenMx
...
AE_t1d712_any_onlybe <- mxRun( AEmod , intervals=FALSE )
summary(AE_t1d712_any_onlybe)
save(AE_t1d712_any_onlybe, file="AE_t1d712_any_onlybe.RData")
##################comparing different models úsing likelihood ratio tests##########################################################################
load("W:/C6_Carlsson/Yuxia Wei/results/familial/trend_240418/AE_t1d712_any.RData")
load("W:/C6_Carlsson/Yuxia Wei/results/familial/trend_240418/AE_t1d712_any_onlyba.RData")
load("W:/C6_Carlsson/Yuxia Wei/results/familial/trend_240418/AE_t1d712_any_nomod.RData")

com1=mxCompare(AE_t1d712_any, AE_t1d712_any_onlyba)
com2=mxCompare(AE_t1d712_any, AE_t1d712_any_onlybe)
com3=mxCompare(AE_t1d712_any, AE_t1d712_any_nomod)
com4=mxCompare(AE_t1d712_any_onlyba, AE_t1d712_any_onlybe)

model="Model 1"
a=summary(AE_t1d712_any)
...
model="Model 2"
b=summary(AE_t1d712_any_onlyba)
...
model="Model 3"
c=summary(AE_t1d712_any_onlybe)
beta1=0
...
model_fitting_t1d712_any=rbind(model1,model2,model3,model4)
model_fitting_t1d712_any=data.frame(model_fitting_t1d712_any)
library(openxlsx)
write.xlsx(model_fitting_t1d712_any,file="model_fitting_t1d712_any.xlsx",overwrite=TRUE)
getwd()
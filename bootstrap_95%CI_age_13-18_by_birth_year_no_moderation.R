#Figure 3(A), Figure 3(B): bootstrapping process to calculate 95%CIs for heritability (age 13-18) in each birth year based on model 4 (without ba or be parameter)
...
################################T1D at age 13-18 years#######################
### Source functions
source( 'W:/C6_Carlsson/Yuxia Wei/do/familial/240418_trend/source_bootfunction_t1d1318_nomoderation.R' )
### Load data
...
# Save or load
saveRDS( aebootResults , 'W:/C6_Carlsson/Yuxia Wei/results/familial/trend_240418/bootrun_t1d1318_no_moderation.Rds' )
aebootResults <- readRDS('W:/C6_Carlsson/Yuxia Wei/results/familial/trend_240418/bootrun_t1d1318_no_moderation.Rds' )
# Check distribution
windows()
par(mfrow=c(1,2))
...
quantile( aebootResults$h2 , c(.025,0.5,.975) ) #median 0.58 (95% CI:0.50,0.66)
quantile( aebootResults$e2 , c(.025,0.5,.975) ) #median 0.42(95% CI:0.34, 0.50)

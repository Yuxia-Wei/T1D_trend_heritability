#Supplementary Table 3: model fitting for likelihood ratio tests: T1D heritability at age 0-6_model 1(with ba and be parameters) based on all sibling pairs
#OpenMx
...
# Fit the model
AE_t1d6_any <- mxRun( AEmod , intervals=TRUE )

summary(AE_t1d6_any)
save(AE_t1d6_any, file="AE_t1d6_any.RData") #"any" means any childhood-onset T1D (t1d18_any) regardless of conflicting tyeps of diagnosis

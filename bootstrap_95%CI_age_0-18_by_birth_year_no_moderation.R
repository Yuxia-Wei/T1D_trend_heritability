#Figure 2 footnote: bootstrapping process to calculate 95%CIs for heritability (age 0-18) in each birth year based on model 14(without ba or be parameter)
...
### Source functions
source( 'W:/C6_Carlsson/Yuxia Wei/do/familial/240418_trend/source_bootfunction_t1d18_nomoderation.R' )
### Load data
...
# Save or load
saveRDS( aebootResults , 'W:/C6_Carlsson/Yuxia Wei/results/familial/trend_240418/bootrun_t1d18_no_moderation.Rds' )
aebootResults <- readRDS('W:/C6_Carlsson/Yuxia Wei/results/familial/trend_240418/bootrun_t1d18_no_moderation.Rds' )
# Check distribution
windows()
par(mfrow=c(1,2))
...
quantile( aebootResults$h2 , c(.025,0.5,.975) ) #(95% CI: 0.79-0.86)
quantile( aebootResults$e2 , c(.025,0.5,.975) ) #(95% CI: 0.14-0.21)

#Figure 2 footnote: source function for bootstrapping to calculate 95%CIs for heritability (age 0-18) in each birth year based on model 4 (without ba or be parameter)

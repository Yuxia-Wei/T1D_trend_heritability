#Supplementary Table 3: model fitting for likelihood ratio tests: T1D heritability at age 0-18_model 4 (without ba or parameter) based on all sibling pairs
#Supplementary Figure 3(D): obtain point estimates for heritability and environmental contribution based on model 4
#OpenMx
...
AE_t1d18_any_nomod <- mxRun( AEmod , intervals=TRUE ) #h2: 0.83[95% CI: 0.80, 0.85]; e2: 0.17 (95% CI: 0.16, 0.20)

#All fit attempts resulted in errors - check sstarting values or model specification
summary(AE_t1d18_any_nomod)
save(AE_t1d18_any_nomod, file="AE_t1d18_any_nomod.RData") #names to be changed

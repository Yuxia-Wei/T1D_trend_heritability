#Supplementary Table 4: model fitting for likelihood ratio tests: T1D heritability at age 0-18_model 3 (with be parameter) based on one sibling pair from each family
#OpenMx
...
AE_t1d18_any_onepair_onlybe <- mxRun( AEmod , intervals=TRUE )
#All fit attempts resulted in errors - check starting values or model specification
summary(AE_t1d18_any_onepair_onlybe)
save(AE_t1d18_any_onepair_onlybe, file="AE_t1d18_any_onepair_onlybe.RData") #names to be changed

###############################comparing different models using likelihood ratio tests###################################################################
load("W:/C6_Carlsson/Yuxia Wei/results/familial/trend_240418/AE_t1d18_any_onepair.RData")
load("W:/C6_Carlsson/Yuxia Wei/results/familial/trend_240418/AE_t1d18_any_onepair_onlyba.RData")
load("W:/C6_Carlsson/Yuxia Wei/results/familial/trend_240418/AE_t1d18_any_onepair_nomod.RData")

com1=mxCompare(AE_t1d18_any_onepair, AE_t1d18_any_onepair_onlyba)
com2=mxCompare(AE_t1d18_any_onepair, AE_t1d18_any_onepair_onlybe)
com3=mxCompare(AE_t1d18_any_onepair, AE_t1d18_any_onepair_nomod)
com4=mxCompare(AE_t1d18_any_onepair_onlyba, AE_t1d18_any_onepair_onlybe)
com1
com2
com3
com4
model="Model 1"
a=summary(AE_t1d18_any_onepair)
...
model="Model 2"
b=summary(AE_t1d18_any_onepair_onlyba)
...
model="Model 3"
c=summary(AE_t1d18_any_onepair_onlybe)
beta1=0
...
model_fitting_t1d18_any_onpair=rbind(model1,model2,model3,model4)
model_fitting_t1d18_any_onpair=data.frame(model_fitting_t1d18_any_onpair)
library(openxlsx)
write.xlsx(model_fitting_t1d18_any_onpair,file="model_fitting_t1d18_any_onpair.xlsx",overwrite=TRUE)
getwd()
#Supplementary Table 3: model fitting for likelihood ratio tests: T1D heritability at age 13-18_model 2(with ba parameter) based on all sibling pairs
#OpenMx
...
AE_t1d1318_any_onlyba <- mxRun( AEmod , intervals=FALSE)
summary(AE_t1d1318_any_onlyba)
save(AE_t1d1318_any_onlyba, file="AE_t1d1318_any_onlyba.RData") #names to be changed

#Supplementary Table 4: model fitting for likelihood ratio tests: T1D heritability at age 13-18_model 4 (without ba or be parameter) based on one sibling pair from each family
#OpenMx
...
AE_t1d1318_any_onepair_nomod <- mxRun( AEmod , intervals=TRUE ) #heritabiblity: 0.61[95% CI: 0.51, 0.70]
                                                                #e2: 0.39 [95% CI: 0.30, 0.49]

summary(AE_t1d1318_any_onepair_nomod)
save(AE_t1d1318_any_onepair_nomod, file="AE_t1d1318_any_onepair_nomod.RData") #names to be changed

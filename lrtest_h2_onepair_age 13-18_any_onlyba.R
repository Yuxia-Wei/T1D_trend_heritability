#Supplementary Table 4: model fitting for likelihood ratio tests: T1D heritability at age 13-18_model 2(with ba parameter) based on one sibling pair from each family
#OpenMx
...
AE_t1d1318_any_onepair_onlyba <- mxRun( AEmod , intervals=FALSE )
summary(AE_t1d1318_any_onepair_onlyba)
save(AE_t1d1318_any_onepair_onlyba, file="AE_t1d1318_any_onepair_onlyba.RData") #"any" means any childhood-onset T1D regardless of conflicting types of diagnosis

#To export results to an excel file
Birth_year=1982
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1982"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1982"]]@result
year1982=data.frame(cbind(Birth_year,h2,e2))
names(year1982)=c("Birth_year","Heritability","Environment")

Birth_year=1983
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1983"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1983"]]@result
year1983=data.frame(cbind(Birth_year,h2,e2))
names(year1983)=c("Birth_year","Heritability","Environment")

Birth_year=1984
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1984"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1984"]]@result
year1984=data.frame(cbind(Birth_year,h2,e2))
names(year1984)=c("Birth_year","Heritability","Environment")

Birth_year=1985
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1985"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1985"]]@result
year1985=data.frame(cbind(Birth_year,h2,e2))
names(year1985)=c("Birth_year","Heritability","Environment")

Birth_year=1986
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1986"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1986"]]@result
year1986=data.frame(cbind(Birth_year,h2,e2))
names(year1986)=c("Birth_year","Heritability","Environment")

Birth_year=1987
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1987"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1987"]]@result
year1987=data.frame(cbind(Birth_year,h2,e2))
names(year1987)=c("Birth_year","Heritability","Environment")

Birth_year=1988
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1988"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1988"]]@result
year1988=data.frame(cbind(Birth_year,h2,e2))
names(year1988)=c("Birth_year","Heritability","Environment")

Birth_year=1989
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1989"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1989"]]@result
year1989=data.frame(cbind(Birth_year,h2,e2))
names(year1989)=c("Birth_year","Heritability","Environment")

Birth_year=1990
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1990"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1990"]]@result
year1990=data.frame(cbind(Birth_year,h2,e2))
names(year1990)=c("Birth_year","Heritability","Environment")

Birth_year=1991
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1991"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1991"]]@result
year1991=data.frame(cbind(Birth_year,h2,e2))
names(year1991)=c("Birth_year","Heritability","Environment")

Birth_year=1992
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1992"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1992"]]@result
year1992=data.frame(cbind(Birth_year,h2,e2))
names(year1992)=c("Birth_year","Heritability","Environment")

Birth_year=1993
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1993"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1993"]]@result
year1993=data.frame(cbind(Birth_year,h2,e2))
names(year1993)=c("Birth_year","Heritability","Environment")

Birth_year=1994
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1994"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1994"]]@result
year1994=data.frame(cbind(Birth_year,h2,e2))
names(year1994)=c("Birth_year","Heritability","Environment")

Birth_year=1995
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1995"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1995"]]@result
year1995=data.frame(cbind(Birth_year,h2,e2))
names(year1995)=c("Birth_year","Heritability","Environment")

Birth_year=1996
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2"]]@result
year1996=data.frame(cbind(Birth_year,h2,e2))
names(year1996)=c("Birth_year","Heritability","Environment")

Birth_year=1997
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1997"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1997"]]@result
year1997=data.frame(cbind(Birth_year,h2,e2))
names(year1997)=c("Birth_year","Heritability","Environment")

Birth_year=1998
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1998"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1998"]]@result
year1998=data.frame(cbind(Birth_year,h2,e2))
names(year1998)=c("Birth_year","Heritability","Environment")

Birth_year=1999
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_1999"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_1999"]]@result
year1999=data.frame(cbind(Birth_year,h2,e2))
names(year1999)=c("Birth_year","Heritability","Environment")

Birth_year=2000
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_2000"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_2000"]]@result
year2000=data.frame(cbind(Birth_year,h2,e2))
names(year2000)=c("Birth_year","Heritability","Environment")

Birth_year=2001
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_2001"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_2001"]]@result
year2001=data.frame(cbind(Birth_year,h2,e2))
names(year2001)=c("Birth_year","Heritability","Environment")

Birth_year=2002
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_2002"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_2002"]]@result
year2002=data.frame(cbind(Birth_year,h2,e2))
names(year2002)=c("Birth_year","Heritability","Environment")

Birth_year=2003
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_2003"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_2003"]]@result
year2003=data.frame(cbind(Birth_year,h2,e2))
names(year2003)=c("Birth_year","Heritability","Environment")

Birth_year=2004
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_2004"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_2004"]]@result
year2004=data.frame(cbind(Birth_year,h2,e2))
names(year2004)=c("Birth_year","Heritability","Environment")

Birth_year=2005
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_2005"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_2005"]]@result
year2005=data.frame(cbind(Birth_year,h2,e2))
names(year2005)=c("Birth_year","Heritability","Environment")

Birth_year=2006
h2=AE_t1d1318_any_onepair_onlyba@algebras[["h2_2006"]]@result
e2=AE_t1d1318_any_onepair_onlyba@algebras[["e2_2006"]]@result
year2006=data.frame(cbind(Birth_year,h2,e2))
names(year2006)=c("Birth_year","Heritability","Environment")

heritability_point_t1d1318_any_onepair_onlyba=rbind(year1982,year1983,year1984,year1985, year1986,year1987,year1988,year1989,year1990,year1991,year1992,year1993,year1994,year1995,year1996,year1997,year1998,year1999,year2000,year2001,year2002,year2003,year2004,year2005,year2006)

library(openxlsx)
write.xlsx(heritability_point_t1d1318_any_onepair_onlyba,file="heritability_point_t1d1318_any_onepair_onlyba.xlsx",overwrite=TRUE)

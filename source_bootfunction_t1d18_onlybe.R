...
#the source function for bootstrapping to calculate 95%CIs for heritability (age 0-18) in each birth year based on model 3 (with only be parameter)
...
AE_t1d18 <- mxRun( AEmod , intervals=TRUE )

return( c(mxEval(h2_1982,AE_t1d18),mxEval(e2_1982,AE_t1d18),mxEval(h2_1983,AE_t1d18),mxEval(e2_1983,AE_t1d18),mxEval(h2_1984,AE_t1d18),mxEval(e2_1984,AE_t1d18),mxEval(h2_1985,AE_t1d18),mxEval(e2_1985,AE_t1d18),mxEval(h2_1986,AE_t1d18),mxEval(e2_1986,AE_t1d18),mxEval(h2_1987,AE_t1d18),mxEval(e2_1987,AE_t1d18),mxEval(h2_1988,AE_t1d18),mxEval(e2_1988,AE_t1d18),mxEval(h2_1989,AE_t1d18),mxEval(e2_1989,AE_t1d18),mxEval(h2_1990,AE_t1d18),mxEval(e2_1990,AE_t1d18),mxEval(h2_1991,AE_t1d18),mxEval(e2_1991,AE_t1d18),mxEval(h2_1992,AE_t1d18),mxEval(e2_1992,AE_t1d18),mxEval(h2_1993,AE_t1d18),mxEval(e2_1993,AE_t1d18),mxEval(h2_1994,AE_t1d18),mxEval(e2_1994,AE_t1d18),mxEval(h2_1995,AE_t1d18),mxEval(e2_1995,AE_t1d18),mxEval(h2,AE_t1d18),mxEval(e2,AE_t1d18),mxEval(h2_1997,AE_t1d18),mxEval(e2_1997,AE_t1d18),mxEval(h2_1998,AE_t1d18),mxEval(e2_1998,AE_t1d18),mxEval(h2_1999,AE_t1d18),mxEval(e2_1999,AE_t1d18),mxEval(h2_2000,AE_t1d18),mxEval(e2_2000,AE_t1d18),mxEval(h2_2001,AE_t1d18),mxEval(e2_2001,AE_t1d18),mxEval(h2_2002,AE_t1d18),mxEval(e2_2002,AE_t1d18),mxEval(h2_2003,AE_t1d18),mxEval(e2_2003,AE_t1d18),mxEval(h2_2004,AE_t1d18),mxEval(e2_2004,AE_t1d18),mxEval(h2_2005,AE_t1d18),mxEval(e2_2005,AE_t1d18),mxEval(h2_2006,AE_t1d18),mxEval(e2_2006,AE_t1d18),mxEval(h2_2007,AE_t1d18),mxEval(e2_2007,AE_t1d18),mxEval(h2_2008,AE_t1d18),mxEval(e2_2008,AE_t1d18),mxEval(h2_2009,AE_t1d18),mxEval(e2_2009,AE_t1d18),mxEval(h2_2010,AE_t1d18),mxEval(e2_2010,AE_t1d18),mxEval(h2dif_0085,AE_t1d18),mxEval(h2dif_0090,AE_t1d18),mxEval(h2dif_0095,AE_t1d18),mxEval(h2dif_1085,AE_t1d18),mxEval(h2dif_1090,AE_t1d18),mxEval(h2dif_1095,AE_t1d18)) )
}

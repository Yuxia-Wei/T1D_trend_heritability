#Supplementary figure 3(B): Point estimates for T1D heritability at age 0-18  in each birth year based on model 3(with be parameter)
#OpenMx
...
library(polycor)
setwd("W:/C6_Carlsson/Yuxia Wei/results/familial/trend_250114") 
...
# Some parameters for outputs
  ...
  mxAlgebra( a^2+(e+(2007-1996)/28*be)^2 , name='Var_2007'),
  mxAlgebra( a^2/Var_2007 , name ='h2_2007'),
  mxAlgebra( (e+(2007-1996)/28*be)^2/Var_2007 , name ='e2_2007'),

  mxAlgebra( a^2+(e+(2008-1996)/28*be)^2 , name='Var_2008'),
  mxAlgebra( a^2/Var_2008 , name ='h2_2008'),
  mxAlgebra( (e+(2008-1996)/28*be)^2/Var_2008 , name ='e2_2008'),

  mxAlgebra( a^2+(e+(2009-1996)/28*be)^2 , name='Var_2009'),
  mxAlgebra( a^2/Var_2009 , name ='h2_2009'),
  mxAlgebra( (e+(2009-1996)/28*be)^2/Var_2009 , name ='e2_2009'),

  mxAlgebra( a^2+(e+0.5*be)^2 , name='Var_2010'),
  mxAlgebra( a^2/Var_2010 , name ='h2_2010'),
  mxAlgebra( (e+0.5*be)^2/Var_2010 , name ='e2_2010'),

  mxAlgebra( h2_2010-h2_1982,name='h2dif_1082' ),
  ...
  mxAlgebra( h2_2000-h2_1982,name='h2dif_0082' ),
...
#mxOption( NULL , 'Default optimizer' , 'SLSQP' ) # try another optimizer use 

AE_t1d18_any_onlybe_h2 <- mxRun( AEmod , intervals=TRUE )
summary(AE_t1d18_any_onlybe_h2)
save(AE_t1d18_any_onlybe_h2, file="AE_t1d18_any_onlybe_h2.RData") #names to be changed

#To export results to an excel file
Birth_year=1982
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1982"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1982"]]@result
year1982=data.frame(cbind(Birth_year,h2,e2))
names(year1982)=c("Birth_year","Heritability","Environment")

Birth_year=1983
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1983"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1983"]]@result
year1983=data.frame(cbind(Birth_year,h2,e2))
names(year1983)=c("Birth_year","Heritability","Environment")

Birth_year=1984
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1984"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1984"]]@result
year1984=data.frame(cbind(Birth_year,h2,e2))
names(year1984)=c("Birth_year","Heritability","Environment")

Birth_year=1985
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1985"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1985"]]@result
year1985=data.frame(cbind(Birth_year,h2,e2))
names(year1985)=c("Birth_year","Heritability","Environment")

Birth_year=1986
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1986"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1986"]]@result
year1986=data.frame(cbind(Birth_year,h2,e2))
names(year1986)=c("Birth_year","Heritability","Environment")

Birth_year=1987
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1987"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1987"]]@result
year1987=data.frame(cbind(Birth_year,h2,e2))
names(year1987)=c("Birth_year","Heritability","Environment")

Birth_year=1988
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1988"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1988"]]@result
year1988=data.frame(cbind(Birth_year,h2,e2))
names(year1988)=c("Birth_year","Heritability","Environment")

Birth_year=1989
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1989"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1989"]]@result
year1989=data.frame(cbind(Birth_year,h2,e2))
names(year1989)=c("Birth_year","Heritability","Environment")

Birth_year=1990
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1990"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1990"]]@result
year1990=data.frame(cbind(Birth_year,h2,e2))
names(year1990)=c("Birth_year","Heritability","Environment")

Birth_year=1991
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1991"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1991"]]@result
year1991=data.frame(cbind(Birth_year,h2,e2))
names(year1991)=c("Birth_year","Heritability","Environment")

Birth_year=1992
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1992"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1992"]]@result
year1992=data.frame(cbind(Birth_year,h2,e2))
names(year1992)=c("Birth_year","Heritability","Environment")

Birth_year=1993
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1993"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1993"]]@result
year1993=data.frame(cbind(Birth_year,h2,e2))
names(year1993)=c("Birth_year","Heritability","Environment")

Birth_year=1994
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1994"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1994"]]@result
year1994=data.frame(cbind(Birth_year,h2,e2))
names(year1994)=c("Birth_year","Heritability","Environment")

Birth_year=1995
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1995"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1995"]]@result
year1995=data.frame(cbind(Birth_year,h2,e2))
names(year1995)=c("Birth_year","Heritability","Environment")

Birth_year=1996
h2=AE_t1d18_any_onlybe_h2@algebras[["h2"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2"]]@result
year1996=data.frame(cbind(Birth_year,h2,e2))
names(year1996)=c("Birth_year","Heritability","Environment")

Birth_year=1997
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1997"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1997"]]@result
year1997=data.frame(cbind(Birth_year,h2,e2))
names(year1997)=c("Birth_year","Heritability","Environment")

Birth_year=1998
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1998"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1998"]]@result
year1998=data.frame(cbind(Birth_year,h2,e2))
names(year1998)=c("Birth_year","Heritability","Environment")

Birth_year=1999
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_1999"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_1999"]]@result
year1999=data.frame(cbind(Birth_year,h2,e2))
names(year1999)=c("Birth_year","Heritability","Environment")

Birth_year=2000
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_2000"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_2000"]]@result
year2000=data.frame(cbind(Birth_year,h2,e2))
names(year2000)=c("Birth_year","Heritability","Environment")

Birth_year=2001
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_2001"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_2001"]]@result
year2001=data.frame(cbind(Birth_year,h2,e2))
names(year2001)=c("Birth_year","Heritability","Environment")

Birth_year=2002
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_2002"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_2002"]]@result
year2002=data.frame(cbind(Birth_year,h2,e2))
names(year2002)=c("Birth_year","Heritability","Environment")

Birth_year=2003
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_2003"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_2003"]]@result
year2003=data.frame(cbind(Birth_year,h2,e2))
names(year2003)=c("Birth_year","Heritability","Environment")

Birth_year=2004
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_2004"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_2004"]]@result
year2004=data.frame(cbind(Birth_year,h2,e2))
names(year2004)=c("Birth_year","Heritability","Environment")

Birth_year=2005
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_2005"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_2005"]]@result
year2005=data.frame(cbind(Birth_year,h2,e2))
names(year2005)=c("Birth_year","Heritability","Environment")

Birth_year=2006
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_2006"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_2006"]]@result
year2006=data.frame(cbind(Birth_year,h2,e2))
names(year2006)=c("Birth_year","Heritability","Environment")

Birth_year=2007
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_2007"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_2007"]]@result
year2007=data.frame(cbind(Birth_year,h2,e2))
names(year2007)=c("Birth_year","Heritability","Environment")

Birth_year=2008
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_2008"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_2008"]]@result
year2008=data.frame(cbind(Birth_year,h2,e2))
names(year2008)=c("Birth_year","Heritability","Environment")

Birth_year=2009
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_2009"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_2009"]]@result
year2009=data.frame(cbind(Birth_year,h2,e2))
names(year2009)=c("Birth_year","Heritability","Environment")

Birth_year=2010
h2=AE_t1d18_any_onlybe_h2@algebras[["h2_2010"]]@result
e2=AE_t1d18_any_onlybe_h2@algebras[["e2_2010"]]@result
year2010=data.frame(cbind(Birth_year,h2,e2))
names(year2010)=c("Birth_year","Heritability","Environment")

h2_each_year_t1d18_any_onlybe=rbind(year1982,year1983,year1984,year1985, year1986,year1987,year1988,year1989,year1990,year1991,year1992,year1993,year1994,year1995,year1996,year1997,year1998,year1999,year2000,year2001,year2002,year2003,year2004,year2005,year2006,year2007,year2008,year2009,year2010)

Birth_year="2000 vs 1982"
Heritability_dif=AE_t1d18_any_onlybe_h2@algebras[["h2dif_0082"]]@result
year0082=data.frame(cbind(Birth_year,Heritability_dif))
names(year0082)=c("Birth_year","Heritability_dif")

Birth_year="2000 vs 1985"
Heritability_dif=AE_t1d18_any_onlybe_h2@algebras[["h2dif_0085"]]@result
year0085=data.frame(cbind(Birth_year,Heritability_dif))
names(year0085)=c("Birth_year","Heritability_dif")

Birth_year="2000 vs 1990"
Heritability_dif=AE_t1d18_any_onlybe_h2@algebras[["h2dif_0090"]]@result
year0090=data.frame(cbind(Birth_year,Heritability_dif))
names(year0090)=c("Birth_year","Heritability_dif")

Birth_year="2000 vs 1995"
Heritability_dif=AE_t1d18_any_onlybe_h2@algebras[["h2dif_0095"]]@result
year0095=data.frame(cbind(Birth_year,Heritability_dif))
names(year0095)=c("Birth_year","Heritability_dif")

Birth_year="2010 vs 1982"
Heritability_dif=AE_t1d18_any_onlybe_h2@algebras[["h2dif_1082"]]@result
year1082=data.frame(cbind(Birth_year,Heritability_dif))
names(year1082)=c("Birth_year","Heritability_dif")

Birth_year="2010 vs 1985"
Heritability_dif=AE_t1d18_any_onlybe_h2@algebras[["h2dif_1085"]]@result
year1085=data.frame(cbind(Birth_year,Heritability_dif))
names(year1085)=c("Birth_year","Heritability_dif")

Birth_year="2010 vs 1990"
Heritability_dif=AE_t1d18_any_onlybe_h2@algebras[["h2dif_1090"]]@result
year1090=data.frame(cbind(Birth_year,Heritability_dif))
names(year1090)=c("Birth_year","Heritability_dif")

Birth_year="2010 vs 1995"
Heritability_dif=AE_t1d18_any_onlybe_h2@algebras[["h2dif_1095"]]@result
year1095=data.frame(cbind(Birth_year,Heritability_dif))
names(year1095)=c("Birth_year","Heritability_dif")

h2_difference_t1d18_any_onlybe=rbind(year0082,year0085,year0090,year0095,year1082,year1085,year1090,year1095)
#install.packages("openxlsx")
library(openxlsx)
write.xlsx(h2_each_year_t1d18_any_onlybe,file="h2_each_year_t1d18_any_onlybe.xlsx",overwrite=TRUE)
write.xlsx(h2_difference_t1d18_any_onlybe,file="h2_difference_t1d18_any_onlybe.xlsx",overwrite=TRUE)
getwd()
View(h2_each_year_t1d18_any_onlybe)
View(h2_difference_t1d18_any_onlybe)

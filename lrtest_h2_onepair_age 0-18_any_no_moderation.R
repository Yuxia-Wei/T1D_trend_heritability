#Supplementary Table 4: model fitting for likelihood ratio tests: T1D heritability at age 0-18_model 4 (without ba or parameter) based on one sibling pair from each family
#OpenMx
...
AE_t1d18_any_onepair_nomod <- mxRun( AEmod , intervals=TRUE ) #h2: 0.80[95% CI: 0.77, 0.84]; e2: 0.20 (95% CI: 0.16, 0.23)

#All fit attempts resulted in errors - check sstarting values or model specification
summary(AE_t1d18_any_onepair_nomod)
save(AE_t1d18_any_onepair_nomod, file="AE_t1d18_any_onepair_nomod.RData") #names to be changed
